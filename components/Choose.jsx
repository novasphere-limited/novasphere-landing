...
export default function Choose() {
  return (
    <div className="main-container mt-[100px] xl:mx-[120px] lg:mx-[70px] md:mx-[35px] sm:mx-[20px] mx-3">
      ...
      <div className="grid-2_diff2 items-center mb-[100px] relative">
        <div className="w-full ">
          <div className="abs-spec-1 lg:w-[604px] bg-[#FFFFFF4D] w-full rounded-[10px] backdrop-blur-md xl:py-[39px] lg:py-[29px] md:py-[19px] sm:py-3 py-2 xl:pe-[97px] lg:pe-[67px] md:pe-[37px] sm:pe-[20px] pe-3 ps-[24px]">
