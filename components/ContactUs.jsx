  ...
  return (
    <div className="main-container sm:flex justify-between items-center md:mt-[59px] mt-[45px] contact-gap xl:mb-[26.5rem] mb-[100px] md:mb-[180px] lg:mb-[250px]">
      <div className="w-full">
        ...
        <p className="font-base mb-7 lg:mb-10 xl:mb-[60px]">
        ...
        >
          ...
          <input
            ...
            required
          />
          <label className="text-base my-5">Email Address</label>
          ...
          <input
            ...
            required
          />
          <div className=" lg:mt-[59px] mt-7 flex items-center justify-center">
            <button
              className="hover:bg-[#1f76d3] max-w-[300px] w-full text-white bg-[#3090F8] text-sm font-semibold py-[10px] rounded-lg"
              type={"submit"}
